...
public class BaseTest {
    ...
    protected static String updateProjectDataPath = "src/test/java/TestData/Update_project.json";

    protected static Data data = MrJson.readData(dataPath);
    protected Response response;
    protected RequestBuilder requestBuilder;
    protected Workspace workspace;
    protected static Project project = MrJson.readProject(projectPath);
